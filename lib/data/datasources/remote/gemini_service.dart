...
class GeminiService {
  ...
  // This URL should point to a secure backend Cloud Function that proxies requests to the Gemini API.
  // NEVER store API keys in the client app.
  static const String _cloudFunctionUrl = 'https://us-central1-plasma-hope-467112-t6.cloudfunctions.net/geminiProxy';
